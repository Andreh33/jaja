  ...
  return (
    <div className="rounded-2xl glass p-6 md:p-8">
        ...
        <div className="flex flex-wrap gap-2">
          {CATEGORIES.map((c) => (
            <button
              ...
              style={category === c.id ? { background: 'rgba(59,130,246,0.2)', color: '#fff', border: '1px solid rgba(59,130,246,0.5)' } : { background: 'rgba(255,255,255,0.04)', color: 'rgba(255,255,255,0.6)', border: '1px solid var(--border-subtle)' }}
            >
              {c.label}
            </button>
          ))}
      ...
      <div
        ...
        style={{
          borderColor: isDragActive ? 'var(--brand-400)' : 'var(--border-strong)',
          background: isDragActive ? 'rgba(59,130,246,0.08)' : 'rgba(3,9,20,0.4)',
        }}
      >
        <input {...getInputProps()} />
        <div className="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl" style={{ background: 'rgba(59,130,246,0.15)', color: 'var(--brand-300)', border: '1px solid rgba(59,130,246,0.3)' }}>
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1.5 h-1 overflow-hidden rounded-full bg-white/10">
                  <div
                    ...
                    style={{
                      width: `${u.progress}%`,
                      background: u.error ? 'var(--danger)' : u.done ? 'var(--accent-ia)' : 'var(--brand-400)',
                    }}
                  />
                </div>
              </div>

...
export default function PricingBand() {
  return <section className="site-container pb-20" aria-labelledby="price-heading"><Reveal className="price-statement">
    ...
    <div className="price-side"><div className="price-display">{CATALOG.webCreationLe8.amount / 100}<span>€</span></div><p className="eyebrow">CREACIÓN · PAGO ÚNICO · IVA INCLUIDO</p><p className="mt-4">Hosting, dominio y SEO básico: {formatEUR(CATALOG.hostingMonthly.amount)}/mes.<br />Complementos opcionales, siempre desglosados.</p><Link href="/tienda/calculadora" className="blue-button">Configurar mi web <ArrowUpRight size={17} /></Link></div>
  </Reveal></section>;
}

    ...
    <AnimatePresence>
      {show && (
        <motion.a
          ...
          style={{ background: '#2563eb', boxShadow: '0 0 0 4px rgba(59,130,246,0.18), 0 10px 40px rgba(59,130,246,0.35)' }}
        >
          <span className="absolute inset-0 rounded-full" style={{ background: '#2563eb', opacity: 0.5 }} />

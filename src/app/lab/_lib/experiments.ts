export const experiments = [
  {
    slug: 'escape', title: 'Escapa de la web', category: 'Juego', number: '01',
  ...
  {
    slug: 'runner', title: 'Latech Runner', category: 'Juego', number: '02',
  ...
  {
    slug: 'lienzo', title: 'Lienzo libre', category: 'Crea', number: '03',
  ...
  {
    slug: 'capo', title: 'Abre el capó', category: 'Explora', number: '04',
    ...
    detail: 'Una explicación visual de nuestra arquitectura con Next.js, React y contenido persistente. El código que aparece es una ilustración simplificada.',
  ...
  {
    slug: 'rayos-x', title: 'Rayos X', category: 'Explora', number: '05',

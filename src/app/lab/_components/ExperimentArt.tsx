...
export default function ExperimentArt({ kind }: { kind: ExperimentSlug }) {
  return <div className={`${styles.art} ${styles[kind === 'rayos-x' ? 'xrayArt' : `${kind}Art`]}`} aria-hidden="true">
    ...
    {kind === 'lienzo' ? <svg viewBox="0 0 500 230" fill="none"><path d="M65 156C122 42 86 211 175 118S192 223 285 81 366 209 438 69" stroke="#8B5CF6" strokeWidth="19" strokeLinecap="round" /><path d="M55 188C173 201 275 166 423 183" stroke="#F97316" strokeWidth="10" strokeLinecap="round" /><circle cx="398" cy="50" r="12" fill="#FBBF24" /><path d="m311 35 5 15 15 5-15 5-5 15-5-15-15-5 15-5Z" fill="#C084FC" /></svg> : null}

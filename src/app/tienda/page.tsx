...
const SHOPS = [
  ...
  },
  {
    ...
    description: 'Configura tu web, revisa los extras y prepara un presupuesto completo para hablarlo por WhatsApp.',
    points: ['Creación y cuota desglosadas', 'Contexto y contacto opcionales', 'Mensaje listo para revisar y enviar'],
    price: 'Desde 600€ + 60€/mes · sin IVA',

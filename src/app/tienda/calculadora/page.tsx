...
export const metadata: Metadata = {
  ...
  description:
    'Configura tu web desde 800 € más mantenimiento mensual. Revisa servicios, extras e IVA y prepara tu presupuesto por WhatsApp, sin registro.',
          ...
          <div className="mx-auto max-w-7xl px-6 text-center">
            <Reveal>
              ...
              <p className="mx-auto mt-7 max-w-2xl text-base leading-relaxed text-white/65">
                Web desde 800 € de creación y 60 €/mes de mantenimiento, IVA no incluido.

...
export default function AdminLoginClient() {
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <style jsx>{`
        .input { width:100%; height:48px; padding:0 14px; border-radius:14px; background:rgba(3,9,20,0.5); border:1px solid var(--border-subtle); color:var(--text-primary); font-size:14px; }
